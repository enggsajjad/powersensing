...
class Metaclass_LogTf(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('custom_msg1')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'custom_msg1.msg.LogTf')
            logger.debug(
...
class LogTf(metaclass=Metaclass_LogTf):
    ...
    def __init__(self, **kwargs):
        ...
        self.sensor1 = kwargs.get('sensor1', str())
        self.volt = kwargs.get('volt', int())
        self.sensor2 = kwargs.get('sensor2', str())
        self.amp = kwargs.get('amp', int())
    ...
    def sensor1(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'sensor1' field must be of type 'str'"
        self._sensor1 = value
    ...
    def volt(self, value):
        if __debug__:
            assert \
                ...
                "The 'volt' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'volt' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._volt = value
    ...
    def sensor2(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'sensor2' field must be of type 'str'"
        self._sensor2 = value
    ...
    def amp(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'amp' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'amp' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._amp = value
