	...
	while(ofs < raw->len)
	{
		switch(p[ofs])
		{
            ...
            case kItemRotationEul:
                fprintf(stderr, "kItemRotationEul\n");
            ...
            case kItemRotationQuat:
                fprintf(stderr, "kItemRotationQuat\n");
				raw->nimu = 1;
