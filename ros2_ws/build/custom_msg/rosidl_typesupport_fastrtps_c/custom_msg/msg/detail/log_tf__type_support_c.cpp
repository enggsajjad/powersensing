...
#include "custom_msg/msg/detail/log_tf__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // log_msg, time_frame
#include "rosidl_runtime_c/string_functions.h"  // log_msg, time_frame

// forward declare type support functions


using _LogTf__ros_msg_type = custom_msg__msg__LogTf;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: log_msg
  {
    const rosidl_runtime_c__String * str = &ros_message->log_msg;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: log_msg
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->log_msg.data) {
      rosidl_runtime_c__String__init(&ros_message->log_msg);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->log_msg,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'log_msg'\n");
      return false;
    }
  }
...
size_t get_serialized_size_custom_msg__msg__LogTf(
  const void * untyped_ros_message,
...
static uint32_t _LogTf__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msg__msg__LogTf(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msg
size_t max_serialized_size_custom_msg__msg__LogTf(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _LogTf__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msg__msg__LogTf(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msg, msg, LogTf)() {
